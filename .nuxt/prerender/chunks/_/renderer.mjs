import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, joinURL } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/vue/server-renderer/index.mjs';
import { a as useRuntimeConfig, b as useStorage, d as defineRenderHandler, g as getRouteRules, u as useNitroApp } from './nitro.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/devalue/index.js';
import { walkResolver } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/unhead/dist/utils.mjs';
import { toValue, isRef, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/coding/pet-projects/MusicTrainer/node_modules/unhead/dist/plugins.mjs';
